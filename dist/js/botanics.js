...
var _initiateDefaults = __webpack_require__(4);

var intDefaultsObj = _interopRequireWildcard(_initiateDefaults);

var _basketModule = __webpack_require__(3);

var basketObj = _interopRequireWildcard(_basketModule);
...
exports.valItemCount = valItemCount;
exports.decrementItemCount = decrementItemCount;
exports.incrementItemCount = incrementItemCount;
function isNumber(strn) {
    var patt1 = /\D/g;
...
$(document).ready(function () {
    ...
    function updateResponse(response) {
        ...
        $.each(response.Cart.Items, function (i, item) {
            items += '<div class="row item">' + '<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">' + item.Description + '</div>' + '<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">' + '<div class="qtnCtrls"><button class="minus" data-inarr="' + i + '">-</button>' + '<input type="text" placeholder="0" min="0" size="3" maxlength="2" value="' + item.Quantity + '" id="itemCount' + i + '" class="quantity" onkeypress="basketFn.valItemCount(this)">' + '<button class="plus" data-inarr="' + i + '">+</button></div>' + '<button class="addToBasketBut" data-inarr="' + i + '" data-item="' + item.ModelName + '">Update</button>' + '</div>' + '<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2" id="itemPrice' + i + '">' + item.Price + '</div>' + '<div class="col-xs-12 col-sm-12 col-md-2 col-lg-2" id="itemTotalPrice' + i + '">' + item.TotalPrice + '</div>' + '</div>';
...
exports.initiateDefaults = initiateDefaults;
